...
<body class="animsition">
                ...
                <div class="container-fluid">
                    <div class="header-mobile-inner">
                        <a class="logo" href="index.html">
                            <img src="{{asset('admin_template/images/icon/logo.png')}}" alt="CoolAdmin" />
                        </a>
    ...
    <!-- Vendor JS       -->
    <script src="{{asset('admin_template/vendor/slick/slick.min.js')}}">
    </script>
    ...
    <script src="{{asset('admin_template/vendor/bootstrap-progressbar/bootstrap-progressbar.min.js')}}">
    </script>
    <script src="{{asset('admin_template/vendor/counter-up/jquery.waypoints.min.js')}}"></script>
    <script src="{{asset('admin_template/vendor/counter-up/jquery.counterup.min.js')}}">
    </script>
    ...
    <script src="{{asset('admin_template/vendor/select2/select2.min.js')}}">
    </script>
